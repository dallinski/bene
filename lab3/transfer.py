...
class Main(object):
    ...
    def parse_options(self):
        ...
        parser.add_option("-l","--loss_rate",type="float",dest="loss",
                          default=0.0,
                          help="random loss rate")

        parser.add_option("-e","--experiments",action="store_true",dest="experiments",
                          help="is experiments portion of assignment")

        (options,args) = parser.parse_args()
        self.filename = options.filename
        self.loss = options.loss
        self.experiments = options.experiments
    ...
    def run(self):
        ...
        # setup connection
        c1 = TcpTahoe(t1,1,1,2,1,a)
        c2 = TcpTahoe(t2,2,1,1,1,a)
